            ...
            if(mouse.pressed == false){
                if(activeP != null){
                    if(validSquare){
                        ...
                        //MOVE CONFIRMED
                        // Update the piece list in case a piece has been captured and removed during the stimulation
        ...
        if(kingCanMove(king)){
            ...
            if(colDiff == 0){
                ...
                if(checkingP.row < king.row){
                    //the checking piece is above the line
                ...
                if(checkingP.col > king.row){
                    //the checking piece is below the line
                    for(int row = checkingP.row; row > king.row; row--){
                        for(Piece piece : simpieces){
                            if(piece != king && piece.color != currentColor && piece.canMove(checkingP.col,row)){
                                return false;
                ...
                if(checkingP.row < king.row){
                    ...
                    if(checkingP.col < king.col){
                    //this checking piece is in the upper left
                ...
                if(checkingP.row > king.row){
                    //this checking piece is below the king
                    if(checkingP.col < king.col){
